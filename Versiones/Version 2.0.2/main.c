		...
		switch(opcS) {
			...
			case 1: //Segunda ejecucion del programa
				...
				switch(opc) {
					...
					//Sin distinción
					case 5: Exit(1); loop = !loop; 	break; //Salir del banco
					case 6: help(1); break; //Pedir ayuda
					case 7: changeConfigBool("showDataFolder.txt"); showDataFolder = !showDataFolder; 	break; //Mostrar carpeta "data"
					case 8: changeConfigBool("fullScreen.txt"); 	fullScreen = !fullScreen; 			break; //Cambiar pantalla completa
